<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="fun1.aspx.cs" Inherits="groupcw.WebForm2" %>
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <small> a table with one column showing the title of DVDs</small>
                        </div>
                    </div>
                </div>
            </div>
